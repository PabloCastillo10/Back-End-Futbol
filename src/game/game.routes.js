...
import { createGame, getGames, getGameByName, listGameByLeague, updateGame, createGameResult, getSearchFechaHora, getTableLeague, getTableLeagueByTeam, getSearchJornada } from "./game.controller.js";
...
router.get("/search/:league/:FechaHora", getSearchFechaHora);
router.get("/jornada/:jornada/:league", getSearchJornada);
